...
**Q: 微服务如何实现配置动态刷新？**
- 📄 [Nacos核心机制详解.md](./06_微服务/核心组件/Nacos核心机制详解.md)
- 配置中心 + @RefreshScope注解
...
**修复问题**：
- ✅ 删除重复的`生产环境问题排查/`（无编号目录），统一到`25_生产环境问题排查/`
- ✅ 修复`17_算法/数据结构`编号冲突（06_树/06_二叉树、07_堆/07_二叉搜索树、09_堆重复）
- ✅ 删除`25_生产环境问题排查/13_网络问题排查.md`（与06_重复）

**完善内容**：
- ✅ 充实`18_DevOps与CICD`4个骨架文档（自动化测试/监控告警/日志收集/GitLab CI/CD）
- ✅ 新增`23_技术动态/2026年5月技术综述.md`
- ✅ 更新`23_技术动态/README.md`，添加已发布综述索引
...
### P0级别（已完成）✅
- [x] Kafka核心机制详解 ✅ 已完成
- [x] Sentinel流量控制详解 ✅ 已完成
- [x] MySQL分库分表实战 ✅ 已完成
- [x] Spring Security与JWT实战 ✅ 已完成

### P1级别（部分完成）
- [x] 系统设计案例集 ✅ 已完成（10个案例：短链接/秒杀/IM/feed流/分布式ID/抢红包/延迟任务/排行榜/限流器/LRU缓存）
- [x] 高并发架构实战 ✅ 已完成（21_系统设计与面试/高并发系统设计.md）
...
- [x] MyBatis核心原理 ✅ 已完成（22_源码解读/08_MyBatis源码解读/ 下4篇深度文档）
- [ ] Zookeeper核心原理
