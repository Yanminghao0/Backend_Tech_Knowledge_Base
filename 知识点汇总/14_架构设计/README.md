...
### 1. 架构设计与技术选型方法论 ⭐ 新增
📄 [架构设计与技术选型方法论.md](./01_架构设计与技术选型方法论.md)
...
- 📄 [04_缓存/缓存架构设计与实战](../04_缓存/02_缓存架构设计与实战.md) - 缓存选型详解
- 📄 [03_数据库/MySQL核心机制详解](../03_数据库/04_MySQL核心机制详解.md) - 数据库选型
- 📄 [05_消息队列/RocketMQ核心机制详解](../05_消息队列/03_RocketMQ核心机制详解.md) - MQ选型
- 📄 [06_微服务/Nacos核心机制详解](../06_微服务/01_核心组件/02_Nacos核心机制详解.md) - 注册中心选型
...
📄 [高并发架构实战案例.md](./07_高并发架构实战案例.md)

**核心内容**：
- ✅ **高并发原则**：无状态/拆分/缓存/异步/削峰/分片
- ✅ **案例一：秒杀系统**：Redis预减库存+MQ异步下单+防超卖
- ✅ **案例二：消息Feed流**：推模式/拉模式/推拉结合
- ✅ **案例三：实时排行榜**：Redis ZSet+分桶优化
- ✅ **案例四：分布式IM**：Netty+MQ+分库分表+消息可靠投递
- ✅ **案例五：短视频推荐**：召回→排序→重排三层架构
- ✅ **通用模式**：限流/降级/熔断/缓存/队列/分片六大模式
