...
### 1. Java高级工程师技术清单 ⭐ 推荐
📄 [Java高级工程师技术清单.md](./01_Java高级工程师技术清单.md)
...
**高频面试题对应**：
- Java基础：[01_Java核心/Java基础核心原理.md](../01_Java核心/02_Java基础核心原理.md)
- JVM相关：[01_Java核心/JVM虚拟机详解.md](../01_Java核心/01_JVM虚拟机详解.md)
- MySQL相关：[03_数据库/MySQL核心机制详解.md](../03_数据库/04_MySQL核心机制详解.md)
- Redis相关：[04_缓存/Redis核心机制详解.md](../04_缓存/01_Redis核心机制详解.md)
