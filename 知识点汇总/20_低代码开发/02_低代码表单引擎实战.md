...
<template>
  <div class="form-designer">
    ...
    <div class="property-panel" v-if="selectedComponent">
      <a-form :model="selectedComponent.props">
        <a-form-item label="字段名称">
          <a-input v-model="selectedComponent.props.field"></a-input>
        </a-form-item>
        <a-form-item label="显示标签">
          <a-input v-model="selectedComponent.props.label"></a-input>
        </a-form-item>
        <a-form-item label="是否必填">
          <a-switch v-model="selectedComponent.props.required"></a-switch>
        </a-form-item>
        <!-- 更多属性配置 -->
      </a-form>
    </div>
