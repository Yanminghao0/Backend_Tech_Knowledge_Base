...
### 1. Netty核心原理详解 ⭐ 推荐
📄 [Netty核心原理详解.md](./02_Netty核心原理详解.md)
...
### 2. HTTP协议与网络编程 ⭐ 推荐
📄 [HTTP协议与网络编程.md](./01_HTTP协议与网络编程.md)
...
- 详见：[HTTP协议与网络编程.md](./01_HTTP协议与网络编程.md#13-http状态码)
...
8. 开始加密通信
```
- 详见：[HTTP协议与网络编程.md](./01_HTTP协议与网络编程.md#22-https握手流程)
...
- ✅ 服务器推送
- ✅ 优先级控制
- 详见：[HTTP协议与网络编程.md](./01_HTTP协议与网络编程.md#31-http11-vs-http2)
...
- 适合实时通信
```
- 详见：[HTTP协议与网络编程.md](./01_HTTP协议与网络编程.md#41-websocket-vs-http)
...
3. 主从Reactor多线程（Netty）：
   ...
   - Worker：处理业务
```
- 详见：[Netty核心原理详解.md](./02_Netty核心原理详解.md#21-三种reactor模型)
...
- Handler：处理器
- ByteBuf：字节缓冲区
- 详见：[Netty核心原理详解.md](./02_Netty核心原理详解.md#3-核心组件详解)
...
- duplicate()：复制共享内存
```
- 详见：[Netty核心原理详解.md](./02_Netty核心原理详解.md#4-零拷贝机制)
...
方案4：自定义协议
```
- 详见：[Netty核心原理详解.md](./02_Netty核心原理详解.md#54-粘包拆包问题)
...
4. 开启泄漏检测
```
- 详见：[Netty核心原理详解.md](./02_Netty核心原理详解.md#61-内存泄漏问题)
